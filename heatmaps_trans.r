...
saveRDS(sc.rna.mu.scale, '../Input_sub/toxo_cdc/rds_ME49_59/sc_rna_spline_mu_scale_rna_trans.rds')
saveRDS(sc.atac.mu.scale, '../Input_sub//toxo_cdc/rds_ME49_59/sc_atac_spline_mu_scale_atac_trans.rds')
